...
- `index.md` — główna karta wiedzy
- `_config.yml` — konfiguracja GitHub Pages (motyw Cayman)
- `README.md` — ten plik

## Użycie

Strona jest w pełni statyczna. Edytuj `index.md`, by aktualizować treść. GitHub Pages automatycznie przebuduje witrynę po pushu.
